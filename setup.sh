...
printf "  4. Sign in to 1Password\n"
printf "  5. Open a new terminal, then run:\n\n"
printf "       bash ~/Documents/dotfiles/post-install.sh\n\n"
printf "     This handles CLI authentication and shell integration.\n"
